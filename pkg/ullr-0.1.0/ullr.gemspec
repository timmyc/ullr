...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-12-17}
  s.description = %q{ullr is a little gem that consumes NOAA weather xml for a given lat/long, and returns a ruby object with 12 hour forecasts along with some sugar to let you know if any sugar will be falling from the sky.}
